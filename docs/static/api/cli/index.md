...
Command-line interface for n8n-as-code

## Overview

This package provides the following functionality:

- **Project Initialization**: Set up new n8n-as-code projects
...
For usage examples and guides, see the [main documentation](/docs/usage/cli).
