...
VS Code extension for n8n workflow editing

## Overview

This package provides the following functionality:

- **Workflow Editing**: Edit n8n workflows directly in VS Code
...
For usage examples and guides, see the [main documentation](/docs/usage/vscode-extension).
